...
public enum StyleDictionarySize {
    public static let androidBodyBoldFontWeight = 700
    ...
    public static let androidH1FontWeight = 400
    public static let androidH2FontWeight = 400
    public static let androidH3FontWeight = 400
    ...
    public static let iosH1FontWeight = 400
    public static let iosH2FontWeight = 400
    public static let iosH3FontWeight = 400
    public static let iosLabelFontWeight = 700
    public static let iosLinkFontWeight = 400
    public static let iosSubtitleFontWeight = 400
    public static let webDesktopBodyBoldFontWeight = 700
    ...
    public static let webDesktopH1FontWeight = 400
    public static let webDesktopH2FontWeight = 700
    public static let webDesktopH3FontWeight = 700
    public static let webDesktopH4FontWeight = 700
    public static let webDesktopLabelFontWeight = 700
    public static let webDesktopLinkFontWeight = 400
    public static let webDesktopSubtitleFontWeight = 400
    public static let webDesktopTitleSuperFontWeight = 400
    public static let webDesktopTitleUltraFontWeight = 400
    public static let webLargeBodyBoldFontWeight = 700
    ...
    public static let webLargeH1FontWeight = 400
    public static let webLargeH2FontWeight = 700
    public static let webLargeH3FontWeight = 700
    public static let webLargeH4FontWeight = 700
    public static let webLargeLabelFontWeight = 700
    public static let webLargeLinkFontWeight = 400
    public static let webLargeSubtitleFontWeight = 400
    public static let webLargeTitleSuperFontWeight = 400
    public static let webLargeTitleUltraFontWeight = 400
    public static let webMobileBodyBoldFontWeight = 700
    ...
    public static let webMobileH1FontWeight = 400
    public static let webMobileH2FontWeight = 700
    public static let webMobileH3FontWeight = 700
    public static let webMobileH4FontWeight = 700
    public static let webMobileLabelFontWeight = 700
    public static let webMobileLinkFontWeight = 400
    public static let webMobileSubtitleFontWeight = 400
    public static let webMobileTitleSuperFontWeight = 400
    public static let webMobileTitleUltraFontWeight = 400
}
